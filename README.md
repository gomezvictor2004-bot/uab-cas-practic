...
├── public/
│   ├── index.html             # Panel web ligero servido por Express
...
La carpeta `public/` contiene un dashboard estático que se sirve automáticamente desde Express. Al arrancar el proyecto (`npm run dev`), visita `http://localhost:3000` para:
